  ...
  return (
    <div className="bg-landing w-full min-h-screen flex flex-col items-center py-10">
      ...
      <div className="flex justify-center mb-6">
        <button
          className={`px-6 py-2 mx-2 rounded-lg ${
            activeTab === "info" ? "bg-secondary text-white" : "bg-gray-800 text-gray-300"
          }`}
        ...
        <button
          className={`px-6 py-2 mx-2 rounded-lg ${
            activeTab === "playlists" ? "bg-secondary text-white" : "bg-gray-800 text-gray-300"
          }`}
        ...
        <button
          className={`px-6 py-2 mx-2 rounded-lg ${
            activeTab === "surveys" ? "bg-secondary text-white" : "bg-gray-800 text-gray-300"
          }`}
      ...
      <div className="tile backdrop-blur-sm p-8 rounded-xl w-[60rem] shadow-xl">
        {activeTab === "info" && (
          <div>
            <h2 className="font-krona text-white text-2xl mb-5">User Information</h2>
            ...
            <p className="text-white mb-4">
              <strong>Top Genres:</strong> {userSummary.topGenres?.join(", ") || "N/A"}
            </p>
            <p className="text-white mb-4">
              <strong>Top Artists:</strong> {userSummary.topArtists?.join(", ") || "N/A"}
            </p>
            <p className="text-white mb-4">
              <strong>Total Playlists Created:</strong> {userSummary.totalPlaylists || 0}
            </p>
          </div>
        )}
        ...
        {activeTab === "playlists" && (
          <div>
            <h2 className="font-krona text-white text-2xl mb-5">Your Playlists</h2>
        ...
        {activeTab === "surveys" && (
          <div>
            <h2 className="font-krona text-white text-2xl mb-5">Your Surveys</h2>
            <div className="overflow-y-auto max-h-[300px]">
              {surveys.length > 0 ? (
                <ul className="text-white">
                  {surveys.map((survey) => (
